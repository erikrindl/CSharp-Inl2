    ...
    public class Member
    {
        ...
        public static List<Member> MembersList()
        {
            List<Member> memberList = new List<Member>
            {
                ...
                new Member { FirstName = "Daniel", LastName = "Arlbring", LocationName = "Alingsås", Age = 24, Accomodation = "Hyr en Lägenhet", Family = "Sambo", Pets = "Inga", LastJob = "Väktare", Hobby = "Motorsport/datorspel", FavoriteFood = "Italienskt", FavoriteMusic = "House", ProgrammingQuote = "-"},
